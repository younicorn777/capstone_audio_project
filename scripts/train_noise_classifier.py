...
RESULT_DIR = os.path.join(BASE_DIR, "results", "ml", "classification")
PLOT_DIR = os.path.join(RESULT_DIR, "plots")

os.makedirs(RESULT_DIR, exist_ok=True)
os.makedirs(PLOT_DIR, exist_ok=True)

SUMMARY_CSV = os.path.join(RESULT_DIR, "classification_summary.csv")
DETAIL_JSON = os.path.join(RESULT_DIR, "classification_report.json")
...
def main():
    print("YAMNet embedding 기반 소음 환경 분류 모델 학습 시작")
    print("-" * 70)
    ...
    # SVM은 feature scaling이 중요하므로 StandardScaler 포함
    models["SVM"] = Pipeline([
    ...
    for model_name, model in models.items():
        ...
        detail_results[model_name] = detail
